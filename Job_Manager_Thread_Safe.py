...
class Job_Manager_Thread_Safe:
    ...
    def __init__(self, max_number_of_process: int, upload_root_path: str, function2call_processes_changes_state: dict,
        ...
        self.__scheduler.add_job(self.__listener.run, 'interval', seconds=flask_interface_consts.INTERVAL_BETWEEN_LISTENER_SAMPLES)
        ...
        self.__scheduler.add_job(self.__monitor.create_and_send_weekly_summary, 'interval', minutes= 60 * 24) # one day
    ...
    def __calc_num_running_processes(self):
        ...
        # TODO: fix running_processes isn't accuracte as processes state is not always accurate in self.__processes_state_dict
        return 0
